		...
		<div class="row">
			...
			<div class="col-sm-8 page-content">
				...
				<div class="title-lines">
					<h3 class="mt0">Recent Reviews</h3>
				</div>
				...
				<div class="candidates-item">
					...
					<h6 class="title"><a href="#">John Doe</a></h6>
					<span class="meta">John Doe, Korea $150 <i>3 days ago</i></span>
					...
					<ul class="list-unstyled">
						<li><strong>Skills:</strong> HTML, PHP, MySQL</li>
					</ul>
				</div>
				...
				<div class="candidates-item">
					...
					<h6 class="title"><a href="#">John Doe</a></h6>
					<span class="meta">John Doe, Korea $100 <i>1 weeks ago</i></span>
					<ul class="stars">
						<li><i class="fa fa-star"></i></li>
						<li><i class="fa fa-star"></i></li>
						<li><i class="fa fa-star"></i></li>
				...
				<div class="candidates-item">
					...
					<h6 class="title"><a href="#">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</a></h6>
					<span class="meta">John Doe, Korea $200 <i>2 weeks ago</i></span>
					<ul class="stars">
						<li><i class="fa fa-star"></i></li>
						<li><i class="fa fa-star"></i></li>
						<li><i class="fa fa-star"></i></li>
